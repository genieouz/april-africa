    <div class="container top">
      ...
      if(isset($flash_message)){
        if($flash_message == TRUE)
        {
          echo '<div class="alert alert-success">';
            ...
            echo '<strong>Succés!</strong> nouveau produit ajouté avec succés.';
          echo '</div>';       
        }else{
      ...
      ?>
        <fieldset>
          ...
          <div class="control-group">
            <label for="inputError" class="control-label">Prix de revient</label>
            <div class="controls">
          ...
          <div class="control-group">
            <label for="inputError" class="control-label">Prix de vente</label>
            <div class="controls">
