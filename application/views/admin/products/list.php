          ...
          <table class="table table-striped table-bordered table-condensed">
            <thead>
              <tr>
                ...
                <th class="red header">Prix de revient</th>
                <th class="red header">Prix de vente</th>
                <th class="red header">Organisation</th>
            ...
            <tbody>
              ...
              foreach($products as $row)
              {
                ...
                echo '<td class="crud-actions">
                  <a href="'.site_url("admin").'/products/update/'.$row['id'].'" class="btn btn-info">modifier</a>  
                  <a href="'.site_url("admin").'/products/delete/'.$row['id'].'" class="btn btn-danger">supprimer</a>
                </td>';
